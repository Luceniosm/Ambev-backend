...
public class SalesController : BaseController
{
    ...
    public async Task<IActionResult> Sale([FromBody]CreateSaleRequest request, CancellationToken cancellationToken)
    {
    ...
    {
        var validator = new CancelSaleResquestValidator();
        var validationResult = await validator.ValidateAsync(request, cancellationToken);
